...
Config.EMPTY_CIRCUIT_TITLE = '量子线路模拟器';
...
Config.TOOLBOX_GROUP_ROWS = 2
Config.TOOLBOX_GROUP_COLS = 15
Config.TOOLBOX_GROUP_SPAN = Config.TOOLBOX_GATE_SPAN * 17 + Config.TOOLBOX_GROUP_SPACING;
 ...
 * @type {number}
 */
Config.MINIMUM_CANVAS_HEIGHT = 300;
