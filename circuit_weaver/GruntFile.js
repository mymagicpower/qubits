...
module.exports = function(grunt) {
    ...
    grunt.registerTask('build-src', [
        ...
        'inject-js-into-html:html/quirk.template.html:out/tmp/minified-src.js:out/CircuitWeaver.html',
        'clean:clean-tmp'
    ]);
    grunt.registerTask('build-debug', [
        ...
        'bootstrap-get-packages:src/main.js:out/tmp/traceur/bootstrap_post_src/run_main.js',
        'concat:concat-traceur-src',
        'inject-js-into-html:html/quirk.template.html:out/tmp/concatenated-src.js:out/CircuitWeaver.html',
        'clean:clean-tmp'
    ]);
